# -*- encoding: utf-8 -*-
# stub: decidim-initiatives 0.31.0 ruby lib

Gem::Specification.new do |s|
  s.name = "decidim-initiatives".freeze
  ...
  s.date = "2025-11-20"
  s.description = "Participants initiatives plugin for decidim.".freeze
  ...
  s.summary = "Decidim initiatives module".freeze
