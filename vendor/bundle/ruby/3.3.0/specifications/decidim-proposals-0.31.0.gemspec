# -*- encoding: utf-8 -*-
# stub: decidim-proposals 0.31.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<doc2text>.freeze, ["~> 0.4.0".freeze, ">= 0.4.8".freeze])
  s.add_runtime_dependency(%q<redcarpet>.freeze, ["~> 3.5".freeze, ">= 3.5.1".freeze])
  ...
  s.add_development_dependency(%q<decidim-budgets>.freeze, ["= 0.31.0".freeze])
  s.add_development_dependency(%q<decidim-conference>.freeze, ["= 0.31.0".freeze])
