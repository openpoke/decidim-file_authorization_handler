# -*- encoding: utf-8 -*-
# stub: decidim-api 0.31.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<devise-jwt>.freeze, ["~> 0.12.1".freeze])
  s.add_runtime_dependency(%q<graphql>.freeze, ["~> 2.4.0".freeze, ">= 2.4.17".freeze])
  s.add_runtime_dependency(%q<graphql-docs>.freeze, ["~> 5.0".freeze])
  s.add_runtime_dependency(%q<rack-cors>.freeze, ["~> 1.0".freeze])
  s.add_development_dependency(%q<decidim-assemblies>.freeze, ["= 0.31.0".freeze])
  s.add_development_dependency(%q<decidim-comments>.freeze, ["= 0.31.0".freeze])
